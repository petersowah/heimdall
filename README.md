...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/heimdall.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/heimdall)
...
```php
$skeleton = new PeterSowah\Heimdall();
echo $skeleton->echoPhrase('Hello, PeterSowah!');
```
